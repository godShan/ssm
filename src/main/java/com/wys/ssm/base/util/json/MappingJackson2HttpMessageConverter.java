package com.wys.ssm.base.util.json;
...
/**
 * 重写spring 的jackson转换类 ,增加对jackson2.0的支持
 * 
 * @author liujiangping
 * 
 */
public class MappingJackson2HttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	...
	{
		objectMapper.setDateFormat(new SimpleDateFormat(JsonUtils.DEFAULT_DATE_PATTERN));
		// 设置输出时包含属性的风格
	...
	protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException,
		...
		JsonGenerator jsonGenerator = this.objectMapper.getFactory().createJsonGenerator(outputMessage.getBody(),
				encoding);
		// This is a workaround for the fact JsonGenerators created by
